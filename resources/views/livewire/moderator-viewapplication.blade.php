<div>
    <div class="container">
        <table class="table table-bordered" border="1" style="width:100%;">
            <tr>
                <td class="logo text-center"><img src="{{asset('/img/logo.png')}}" style="width:150px;height:180px;"/>
                </td>
            ...
            <tr>
                <td colspan="3">
                    <div class="col-md-6">
                        @if(!empty($form['hsc_roll']))
                            Class Roll: <span style="color:green;font-weight: bold;">{{$form['hsc_roll']}}</span>
                        @else
                            Class Roll: <span style="color:red;"> Will be generated after Approval</span>
                        @endif
                    </div>
                    <div class="col-md-6">
                        @if(!empty($form['hsc_section']))
                            Section: <span style="color:green;font-weight: bold;">{{$form['hsc_section']}}</span>
                        @else
            ...
            @if($form['transaction']['transaction_status']==1)
                <tr>
                    <td colspan="3">
                        <div class="row container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-4">Name of Bank:
                                {{ $form['transaction']['bank_name'] }}
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">Date of Transaction:
                                {{ $form['transaction']['transaction_date'] }}
                            </div>
                            <div class="col-md-4">Transaction Number:
                                {{ $form['transaction']['transaction_number'] }}
                            </div>
                            <div class="col-md-4">Transaction Amount:
                                {{ $form['transaction']['transaction_amount'] }}
                            </div>
                        </div>
                    </td>
                </tr>
                ...
                @endif
            @else
                <h4 class="text-danger">Not Paid. Pleas complete payment first to approve.</h4>
            @endif
        </table>
    </div>
    <script>
